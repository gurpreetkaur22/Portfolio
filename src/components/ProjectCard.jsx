    ...
    return (
        ...
        <div className='flex gap-5'>
            ...
            <div className="flex flex-col gap-2 ">
                ...
                <div className='flex gap-10 item relative'>
                    <div className="relative preview-img">
                        <img
                    ...
                    <video 
                        ...
                        muted
                        loop
                        playsInline src={project.video} className="absolute h-96 w-198 inset-0 object-cover rounded-xl"></video>
                    </div>
